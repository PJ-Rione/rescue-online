...
import rioneviewer3.Rione_Exporter_Source;
...
public class SampleTacticsAmbulanceTeam extends TacticsAmbulanceTeam
{
    ...
    private Rione_Exporter_Source exporter=new Rione_Exporter_Source();
    ...
    public Action think(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData){
    	Action action=think_original(agentInfo, worldInfo, scenarioInfo, moduleManager, messageManager, developData);
    	exporter.exportAgentInfo(worldInfo, agentInfo, messageManager, action, this.target);
    	return action;
    }
    
    private Action think_original(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData)
    {
        ...
        // autonomous
        target = this.humanDetector.calc().getTarget();
